"""
Django settings for NeuroVaidya project.
"""
...
SECRET_KEY = os.getenv("SECRET_KEY", "django-insecure-neurovaidya-dev-key-change-in-production")
...
# Add the Render dynamic hostname if available
if "RENDER_EXTERNAL_HOSTNAME" in os.environ:
    ALLOWED_HOSTS.append(os.environ["RENDER_EXTERNAL_HOSTNAME"])
# Fallback for some Render configurations
